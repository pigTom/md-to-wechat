...
export const rose: Theme = {
  ...
  styles: {
    ...
    pre:  'background:#2d1b24;border-radius:6px;padding:12px 16px;overflow:auto;margin:12px 0;white-space:pre;-moz-tab-size:2;tab-size:2;',
    code: 'font-family:Consolas,Monaco,"Courier New",monospace;font-size:13px;color:#f8c8d4;white-space:pre;',
